...
library(help="MASS") # Informação sobre um paquete específico
...
```{r, echo=TRUE, eval=FALSE, `code-line-numbers`="1|3|5|7|10|12|14|17|20|23|25|28"}
...
plot(dem, main = "SRTM", col=topo.colors(300))
```
...
-   Ainda faltam converte para o pacote digeoqR as funções para:
-   Gráficos EDA
-   Mapas
-   Outras análises exploratórias (PCA, FA, regressão, RF...)
