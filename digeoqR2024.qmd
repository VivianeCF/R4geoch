...
4.  Atualização das últimas técnicas estatísticas
...
-   é um R que é executado de maneira mais lenta, com pouco processamento e sem poder carregar pacotes: <https://rdrr.io/snippets/>

## 

#### Mensagem inicial {style="font-size: 30px;"}
...
+------------+-------------------------------------------------------------------------------------------+
| Console    | Imprime na tela as sentenças executadas a partir do editor ou diretamente no console      |
+------------+-------------------------------------------------------------------------------------------+
| Run        | Executa uma instrução do editor (Ctrl+Enter) onde está o cursor ou o que está selecionado |
+------------+-------------------------------------------------------------------------------------------+
| Enviroment | Lista todos os objetos gerados em cada sessão                                             |
+------------+-------------------------------------------------------------------------------------------+
...
+------------+-------------------------------------------------------------------------------------------+
| Plot       | Imprime os gráficos                                                                       |
+------------+-------------------------------------------------------------------------------------------+
| Packages   | É um gerenciador de pacotes instalados                                                    |
+------------+-------------------------------------------------------------------------------------------+
| Help       | Ajuda rápida                                                                              |
+------------+-------------------------------------------------------------------------------------------+
...
Existem diferentes maneiras de program,ar. É importante ser cuidadoso na maneira de escrever seu código para que seja fácil replicar e ler o código.\
...
```{r, echo=TRUE}
ls() # lista os objetos que estão na memória em ".GlobalEnv"
```
...
Este fluxo de trabalho tem seus problemas (ver esta discussão e estes pacotes: [aqui](https://cran.r-project.org/web/packages/here/index.html) e [rprojroot](https://cran.r-project.org/web/packages/rprojroot/index.html)
...
A função `options()` permite o usuário definir e examinar opções globais.\
As opções afetam a maneira como R calcula e exibe seus resultados.

`digits`: número de digitos significativos a serem impressos
...
`width`: Lagura do texto de saída
...
-   Quando aparece uma mensagem de erro ou de alerta não significa que o que estamos fazendo é certo!
...
litho_max <- lito_bacia_sc[[2]]
 ...
 info_bol <- quimica$`informação do boletim`
